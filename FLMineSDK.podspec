Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/XLMARK/FLMineSDK.git", :tag => "0.1.3" }         #存储库的git地址，以及tag值
  #s.source_files  = "FLMineSDK/**/*.{h,m}" #需要托管的源代码路径
  s.source_files  = "FLMineSDK/**/FLSDK.framework"
